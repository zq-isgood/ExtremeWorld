...
-- --------------------------------------------------
-- Date Created: 04/10/2024 14:53:31
-- Generated from EDMX file: D:\MyMmorpg\MyMMORPG-master\Src\Server\GameServer\GameServer\Entities.edmx
-- --------------------------------------------------
...
IF OBJECT_ID(N'[dbo].[FK_TGuildTGuildApply1]', 'F') IS NOT NULL
    ALTER TABLE [dbo].[TGuildApplies] DROP CONSTRAINT [FK_TGuildTGuildApply1];
GO

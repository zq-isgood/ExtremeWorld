...
public class GameObjectManager : MonoSingleton<GameObjectManager>
{
    ...
    protected override void OnStart()
    {
        ...
        CharacterManager.Instance.OnCharacterEnter += OnCharacterEnter; //characterManager调用的这个事件
    ...
    private void InitGameObject(GameObject go,Character character)
    {
        ...
        if (ec != null)
        {
            ...
            ec.Ride(character.Info.Ride); //ec是entityController
            //把这个controller给生物
    ...
    {
        var rideDefine = DataManager.Instance.Rides[rideId]; //判断坐骑是否存在
        Object obj = Resloader.Load<Object>(rideDefine.Resource); //判断资源是否存在
        if (obj == null)
        {
